...
`;
  ...
  return (
    <div id="stats-reports-container" className="space-y-6">
      ...
      <div id="printable-report-card" className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xs space-y-6 vibrant-card">
        
        {/* Report Document Title */}
        <div className="text-center space-y-1.5 border-b border-slate-100 dark:border-slate-700 pb-5">
          <h4 className="text-xs uppercase tracking-widest font-extrabold text-slate-400 dark:text-slate-400 font-display">{schoolName}</h4>
          <h2 className="text-lg md:text-2xl font-black text-slate-800 dark:text-slate-100 font-display">BÁO CÁO ĐÁNH GIÁ CHẤT LƯỢNG MÔN TIN HỌC</h2>
        ...
        {totalAssessmentsCount === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 dark:bg-slate-700/30 rounded-2xl border border-slate-100 dark:border-slate-700/60 flex flex-col items-center justify-center space-y-4">
            ...
            <div className="p-5 bg-slate-50 dark:bg-slate-700/30 rounded-2xl border border-slate-100 dark:border-slate-700/60 space-y-5 flex flex-col justify-center">
